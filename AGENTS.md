...
export const CommandType = {
    ...
    ADD: "add", EDIT: "edit", DONE: "done", UNDONE: "undone", FAIL: "fail", DELETE: "delete",
    // Progress commands
    INCREMENT: "+", DECREMENT: "-", SET: "set",
    // Information commands
    LIST: "list", SHOW: "show", CHECK: "check", HELP: "help",
    // Admin commands
    CLEAR_ALL: "clearall", CLEAR_DONE: "cleardone",
} as const;
