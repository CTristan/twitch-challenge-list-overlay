import { STORAGE_MESSAGES } from "../types/MessageConstants";
    ...
    public handleStorageError(
        ...
        if (!this.isStorageAvailable()) {
            return {
                ...
                message: STORAGE_MESSAGES.LOCALSTORAGE_UNAVAILABLE,
            };
        }
        ...
        if (
            ...
            return {
                ...
                message: STORAGE_MESSAGES.STORAGE_QUOTA_EXCEEDED,
            };
        }
        ...
        if (
            ...
            return {
                canFallback: true,
                fallbackStrategy: "memory-only",
                message: STORAGE_MESSAGES.STORAGE_ACCESS_DENIED,
            };
        }
        ...
        return {
            ...
            message: STORAGE_MESSAGES.STORAGE_OPERATION_FAILED.replace(
                "{error}",
                error.message
            ),
        };
