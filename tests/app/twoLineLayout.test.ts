...
describe("Two-Line Challenge Layout", () => {
  ...
  describe("DOM Structure", () => {
    ...
    it("should create single-line structure for legacy challenges", () => {
      const challenge = new Challenge("Legacy Challenge", { isLegacy: true });
      challengeList.challenges.push(challenge);
      challengeList.totalChallenges++;
      ...
      textElements.forEach((textElement) => {
        ...
        const titleElement = textElement.querySelector(".challenge-title");
        expect(titleElement).toBeTruthy();
        expect(titleElement?.textContent).toBe("Legacy Challenge");

        // Should NOT contain description element (since title === description)
        const descriptionElement = textElement.querySelector(".challenge-description");
  ...
  describe("Styling and Layout", () => {
    it("should apply proper CSS classes for styling hierarchy", () => {
      ...
      const textElement = document.querySelector(".challenge-text") as HTMLElement;
