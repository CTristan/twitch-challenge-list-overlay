...
describe("WindowRefreshManager", () => {
  ...
  describe("BroadcastChannel communication", () => {
    ...
    it("should receive and process valid messages from other windows", async () => {
      ...
      window.location.hash = '';
      const viewerManager = new WindowRefreshManager({ refreshDelay: 50 });
    ...
    it("should ignore messages from the same window type", async () => {
      ...
      window.location.hash = '#admin';
      const adminManager1 = new WindowRefreshManager({ refreshDelay: 50 });
      const adminManager2 = new WindowRefreshManager({ refreshDelay: 50 });
    ...
    it("should ignore invalid messages", () => {
      ...
      channel.listeners.get('message')![0](invalidMessage);
  ...
  describe("error handling", () => {
    ...
    it("should handle postMessage errors", () => {
      ...
      vi.spyOn(MockBroadcastChannel.prototype, 'postMessage').mockImplementation(() => {
